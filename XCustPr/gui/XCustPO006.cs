...
namespace XCustPr
{
    public class XCustPO006:Form
    {
        ...
        public XCustPO006(ControlMain cm)
        {
            ...
            cTxtE = Color.Yellow;
            this.Text = "Last Update 2017-12-27 10.21 ";
        }
        private void initConfig()
        {
            cPo006 = new ControlPO006(Cm);
            initCompoment();
            pB1.Visible = false;
        ...
        private void initCompoment()
        {
            ...
            lb1.AutoSize = true;
            Controls.Add(lb1);
            lb1.Location = new System.Drawing.Point(cPo006.formFirstLineX, cPo006.formFirstLineY + gapLine);

            lb2 = new MaterialLabel();
            lb2.Font = cPo006.fV1;
            lb2.Text = "Program Name XcustPO006";
            lb2.AutoSize = true;
            Controls.Add(lb2);
            lb2.Location = new System.Drawing.Point(grd3, cPo006.formFirstLineY + gapLine);

            txtFileName = new MaterialSingleLineTextField();
            txtFileName.Font = cPo006.fV1;
            txtFileName.Text = "";
            txtFileName.Size = new System.Drawing.Size(300 - grd1 - 20 - 30, ControlHeight);
            Controls.Add(txtFileName);
            txtFileName.Location = new System.Drawing.Point(grd1, cPo006.formFirstLineY + gapLine);
            ...
            pB1.Location = new System.Drawing.Point(cPo006.formFirstLineX + 5, line41);

            lv1 = new MaterialListView();
            lv1.Font = cPo006.fV1;
            lv1.FullRowSelect = true;
            lv1.Size = new System.Drawing.Size(formwidth - 40, formheight - line3 - 100);
            lv1.Location = new System.Drawing.Point(cPo006.formFirstLineX + 5, line42);
            lv1.FullRowSelect = true;
        ...
        {
            //cPo006.processGenCSV(lv1, this, pB1);
        }
