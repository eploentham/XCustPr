...
namespace XCustPr
{
    public class XCustAP004 : Form
    {
        ...
        public XCustAP004(ControlMain cm)
        {
        ...
        private void initConfig()
        {
            ...
            txtFileName.Text = Cm.initC.AP004PathInitial;
            ...
            int i = 1;
            if (Cm.initC.AP004PathInitial.Equals(""))
            {
                MessageBox.Show("Path Config AP004 ไม่ถูกต้อง", "");
                disableBtn();
                return;
            }
        ...
        private void initCompoment()
        {
            ...
            lb1.AutoSize = true;
            Controls.Add(lb1);
            lb1.Location = new System.Drawing.Point(cAp004.formFirstLineX, cAp004.formFirstLineY + gapLine);

            lb2 = new MaterialLabel();
            lb2.Font = cAp004.fV1;
            lb2.Text = "Program Name XcustAP004";
            lb2.AutoSize = true;
            Controls.Add(lb2);
            lb2.Location = new System.Drawing.Point(grd3, cAp004.formFirstLineY + gapLine);

            txtFileName = new MaterialSingleLineTextField();
            txtFileName.Font = cAp004.fV1;
            txtFileName.Text = "";
            txtFileName.Size = new System.Drawing.Size(300 - grd1 - 20 - 30, ControlHeight);
            Controls.Add(txtFileName);
            txtFileName.Location = new System.Drawing.Point(grd1, cAp004.formFirstLineY + gapLine);
            ...
            pB1.Location = new System.Drawing.Point(cAp004.formFirstLineX + 5, line41);

            lv1 = new MaterialListView();
            lv1.Font = cAp004.fV1;
            lv1.FullRowSelect = true;
            lv1.Size = new System.Drawing.Size(formwidth - 40, formheight - line3 - 100);
            lv1.Location = new System.Drawing.Point(cAp004.formFirstLineX + 5, line42);
            lv1.FullRowSelect = true;
