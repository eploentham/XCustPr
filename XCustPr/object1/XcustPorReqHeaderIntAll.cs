...
namespace XCustPr
{
    ...
    {
        public String REQ_HEADER_INTERFACE_ID = "", INTERFACE_SOURCE_CODE = "", REQ_BU_NAME = "", BATCH_ID = "", STATUS_CODE = "", APPROVER_EMAIL_ADDR = "", REQUESTER_EMAIL_ADDR = "";
        public String REQUITITION_NUMBER = "", DESCRIPTIONS = "", ATTRIBUTE_CATEGORY = "";
        ...
        public String LAST_UPDATE_DATE = "", CREATION_DATE = "", LAST_UPDATE_BY = "", CREATE_BY = "", IMPORT_SOURCE = "", request_id="";
    }
}
